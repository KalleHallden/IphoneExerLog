...
class Colors: UIColor {
    ...
    func setColors() {
        Colors.blackTheme = theme.getSuperDark()
        
        if (Colors.blackTheme) {
                print("Finally")
                Colors.grey = .black
                Colors.greens = UIColor(red:0.83, green:0.83, blue:0.83, alpha:1.0)
                Colors.whites = UIColor(red:0.83, green:0.83, blue:0.83, alpha:1.0)
                Colors.blacks = UIColor(red:0.83, green:0.83, blue:0.83, alpha:1.0)
